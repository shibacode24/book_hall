                                    ...
                                    <div class="utf_listing_item" style="border-radius: 20px;">
                                        ...
                                        <div class="utf_listing_item_content">
                                            <div class="utf_listing_item-inner">
                                               ...
                                               <a href="tel:{{ $vendor_search_results->phone_number }}"> <button class="button3 button_new" style="border-radius: 50px;">
                                                ...
                                                <a href="tel:{{ $vendor_search_results->alternate_phone_number }}"><button class="button3 button_new" style="border-radius: 50px;">
                                                    <i class="fa fa-phone" style="font-size: 20px; padding-top: 5px;"></i>
                                                    &nbsp;{{ $vendor_search_results->alternate_phone_number }}
													</button></a><br>
                                                    @endif

                                                 <a href="mailto:{{ $vendor_search_results->email }}"><button class="button3 button_new" style="border-radius: 50px; width:auto; padding:5px 10px;">
